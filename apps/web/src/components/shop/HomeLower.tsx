        ...
        <div className="scroll-row" style={{ ["--row-gap" as string]: "12px" }}>
          {BUDGETS.map((b) => (
            <Link
              ...
              className="flex h-[76px] w-[132px] shrink-0 flex-col justify-center rounded-card bg-deals-bg px-4 transition-transform duration-press ease-out active:scale-[0.96]"
            >
              ...
              <span className="font-body text-[22px] font-semibold leading-none tracking-[-0.01em] text-deals-link">
                {b.label}
              </span>
        ...
        <div className="scroll-row" style={{ ["--row-gap" as string]: "12px" }}>
          {RECIPIENT_ROW.map((r) => (
            <Link
              ...
              className="flex h-[76px] w-[104px] shrink-0 flex-col items-center justify-center gap-1 rounded-card bg-deals-bg transition-transform duration-press ease-out active:scale-[0.96]"
            >
              {/* Matched to the budget tiles above: these two rows sit next
                  to each other and one serif + one sans read as a mistake. */}
              <span className="font-body text-[17px] font-semibold leading-none text-deals-link">
                {r.label}
              </span>
            </Link>
          ))}
